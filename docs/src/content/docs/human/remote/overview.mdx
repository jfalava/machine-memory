...
The same Worker can serve agents over the Model Context Protocol. See [MCP](/mcp/overview) for infrastructure overview, OAuth enablement, the public init script, and tools.
