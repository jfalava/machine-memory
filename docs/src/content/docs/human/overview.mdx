...
For agent access **without** the CLI, see the top-level [MCP](/docs/mcp/overview) section (infrastructure, OAuth, init script, and tools).
...
| [`remote provision`](/human/remote/provision)      | Deploy a new Alchemy D1 stack and save its credentials. Also used for [MCP infrastructure](/docs/mcp/infrastructure). |
