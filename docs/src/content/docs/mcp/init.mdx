...
- Use MCP tools only (`list_repositories`, `memory_suggest`, `memory_query`, `memory_get`, `memory_list`, `memory_verify`, `memory_diff`, `memory_size`, `memory_add`, `memory_update`, `memory_delete`)
