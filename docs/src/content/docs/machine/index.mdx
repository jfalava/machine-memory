...
| [`upgrade`](/machine/upgrade) | Download and replace the current platform binary from the latest GitHub release. |
...
| Command | Purpose |
| --- | --- |
| [`query`](/machine/query) | Full-text search memories by terms and filters. |
