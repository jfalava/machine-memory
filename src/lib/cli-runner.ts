...
import { helpPayload } from "./cli/help";
import { parseOutputMode, parseSqliteErrorDetails } from "./cli/shared";
import { upgrade } from "./upgrade";
import { handleTagMapCommand } from "./cli/commands/tag-map";
import {
  handleAddCommand,
  handleDeleteCommand,
  handleDeprecateCommand,
  handleUpdateCommand,
} from "./cli/commands/memory-write";
import {
  handleDiffCommand,
  handleGetCommand,
  handleListCommand,
